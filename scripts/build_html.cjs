...
const reviewItems = Object.entries(reviews).slice(0, 15).map(([title, item]) => {
  ...
  return "<div class='review-item'><div class='review-book'>📖 " + title + "</div><div class='review-snippet'>" + snippet + "</div></div>";
}).join('\n');
